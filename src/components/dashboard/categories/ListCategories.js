...
const ListCategories = () => {
  ...
  return (
    <div className="m-auto md:w-2/3 px-4">
      <table className="w-full text-sm lg:text-base" cellSpacing="0">
        ...
        <tbody>
          {categories?.length > 0 ?
            ...
            : <tr className="text-center"><td>No categories yet</td></tr>
            }
        </tbody>
      </table>
      {success && (<div className="py-4 text-blue-800 text-md italic text-center">
          {success.message}
        </div>
        )
      }
