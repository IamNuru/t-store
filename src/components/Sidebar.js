    ...
    <div className="md:pb-8 transition-all duration-1000 -mt-14 md:mt-16 bg-white md:shadow-2xl px-2 py-2 z-20 w-full text-center md:w-48 md:h-screen fixed">
      <nav className="hidden md:block">
        <ul className="border-b pb-6 block whitespace-nowrap overflow-auto justify-center text-left">
          ...
          <li className={`${pathname==='/jewellery' && 'text-red-600 ml-2'} text-gray-600 hover:text-black mb-1 transition duration-400 px-4 py-2 md:px-0 md:py-0`}>
            <Link to="/jewellery" className="px-2 inline-block w-full">
              Jewellery
            </Link>
          </li>
          <li className={`${pathname==='/electronics' && 'text-red-600 ml-2'} text-gray-600 hover:text-black mb-1 transition duration-400 px-4 py-2 md:px-0 md:py-0`}>
            <Link to="/electronics" className="px-2 inline-block w-full">
              Electronics
            </Link>
          </li>
          <li className={`${pathname==='/men\'s clothing' && 'text-red-600 ml-2'} text-gray-600 hover:text-black mb-1 transition duration-400 px-4 py-2 md:px-0 md:py-0`}>
            <Link to="/men's clothing" className="px-2 inline-block w-full">
              Men's Clothing
            </Link>
          </li>
          <li className={`${pathname==='/women\'s clothing' && 'text-red-600 ml-2'} text-gray-600 hover:text-black mb-1 transition duration-400 px-4 py-2 md:px-0 md:py-0`}>
